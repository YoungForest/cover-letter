...
\def\position{Java/Kotlin Engineer} % position
\def\company{Trifork} % company
\def\source{on Google} % where was the posting found, "I found ____ "

% FULL SENTENCES
\def\companynews{I understand that \company\;was a famous company in Netherlands and a good employer.}
