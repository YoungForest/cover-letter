...
\def\position{Back-End Software Engineer} % position
\def\company{HENNGE} % company
\def\source{on StackOverflow} % where was the posting found, "I found ____ "

% FULL SENTENCES
\def\companynews{I understand that \company\;was a famous company in Japan and a leading cloud-based security provider.}
